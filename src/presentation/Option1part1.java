...
public class Option1part1 {
	...
	public Option1part1(ArrayList<ActivityType> aList) {
		...
		act1.addtoList(act1, aList,null);
		}
		if(choose3==2) {//routine seçildi
			...
			if(choose7==1) {//dayly seçildi
				...
				if(choose4==1) {
					...
					act.daylyActivityWithDeadline(ract, aList,null);
				}
				else if(choose4==2) {
					act.nextdaylyactivities(ract, aList,null);
				}
			}
			if(choose7==2) {//weekly seçildi
				...
				if(choose4==1) {
					...
					ract.setDeadline(deadline);
					System.out.println("deadline is " +ract.getDeadline());
					act.weeklyActivityWithDeadline(ract, aList,null);
				}
				else if(choose4==2) {
					act.nextweeklyactivities(ract, aList,null);
				}
			}
			if(choose7==3) {//monthly
				...
				if(choose4==1) {
					...
					ract.setDeadline(deadline);
					System.out.println("deadline is " +ract.getDeadline());
					act.monthlyActivityWithDeadline(ract, aList,null);
				}
				else if(choose4==2) {
					act.nextmonthlyactivities(ract, aList,null);
				}
			}
		}		
	}
